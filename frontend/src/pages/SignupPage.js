...
export default function SignupPage() {
  ...
  const strengthColor = ['', 'var(--danger)', 'var(--warning)', '#9AE6B4', 'var(--accent)', 'var(--success)'][strength];
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 32, justifyContent: 'center' }}>
          ...
          <span style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: '1.3rem' }}>ResumeAI</span>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
          <Input
            label="Full Name" required value={form.name} placeholder="Jane Doe"
          ...
          />
          <Input
            label="Email Address" type="email" required value={form.email} placeholder="you@example.com"
          ...
          <Input
            ...
            value={form.confirm} placeholder="Re-enter password"
          ...
          <label style={{ display: 'flex', alignItems: 'flex-start', gap: 10, cursor: 'pointer' }}>
            <input type="checkbox" required style={{ marginTop: 3, accentColor: 'var(--primary)', cursor: 'pointer' }} />
