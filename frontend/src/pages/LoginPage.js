      ...
      <div style={{
        ...
        <div style={{ maxWidth: 420 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 48 }}>
            ...
            <span style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: '1.4rem' }}>ResumeAI</span>
          </div>
          ...
          <p style={{ fontSize: '1rem', color: 'var(--text-secondary)', lineHeight: 1.7, marginBottom: 40 }}>
            Upload your resume and get instant AI-powered feedback, skill analysis, and actionable improvement tips.
          </p>
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: 400, animation: 'fadeIn 0.4s ease' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <button type="button" onClick={() => setShowPw(p => !p)} style={{
                position: 'absolute', right: 12, bottom: errors.password ? 28 : 12,
          ...
          <div style={{
            ...
            <strong style={{ color: 'var(--text-secondary)' }}>New here?</strong> Create a free account in seconds — no credit card required.
          </div>
        </div>
      </div>
    </div>
