...
const Icons = {
  ...
  brain:     "M9.5 2A2.5 2.5 0 017 4.5v0A2.5 2.5 0 014.5 7H4a2 2 0 00-2 2v2a2 2 0 002 2h.5A2.5 2.5 0 017 15.5v0A2.5 2.5 0 019.5 18h5a2.5 2.5 0 002.5-2.5v0A2.5 2.5 0 0119.5 13H20a2 2 0 002-2V9a2 2 0 00-2-2h-.5A2.5 2.5 0 0117 4.5v0A2.5 2.5 0 0114.5 2h-5z",
};
...
export default function AppLayout() {
  ...
  const sidebarStyle = {
    ...
    zIndex: 100, transition: 'transform var(--transition-slow)',
  };
    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <aside style={{
        ...
        <nav style={{ flex: 1, padding: '20px 12px', display: 'flex', flexDirection: 'column', gap: 4 }}>
          <div style={{ fontSize: '0.7rem', color: 'var(--text-muted)', padding: '0 4px 8px', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase' }}>
            Main
          </div>
      ...
      <div style={{
        ...
        {/* Page content */}
        <main style={{ flex: 1, padding: '32px 28px', maxWidth: 'var(--content-max)', width: '100%' }}>
