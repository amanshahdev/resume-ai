...
const blend = (rgb, alpha) => `rgba(${rgb}, ${alpha})`;
...
export const Button = ({
  ...
  const sizes = {
    sm: { padding: "8px 14px", fontSize: "0.78rem" },
    md: { padding: "11px 20px", fontSize: "0.88rem" },
    lg: { padding: "14px 26px", fontSize: "0.96rem" },
  };
  ...
  const variants = {
    primary: {
      ...
      boxShadow: "0 10px 22px var(--primary-glow)",
    },
    secondary: {
    ...
    accent: {
      ...
      boxShadow: "0 10px 22px rgba(239, 142, 82, 0.28)",
    },
    ghost: {
    ...
    danger: {
      color: "var(--text-inverse)",
      background: "linear-gradient(135deg, var(--danger), #b04343)",
    },
  };
...
export const Badge = ({ children, variant = "default", size = "sm" }) => {
  const variants = {
    ...
    primary: {
      bg: blend("15, 123, 108", 0.12),
      color: "var(--primary-dark)",
      border: blend("15, 123, 108", 0.35),
    },
    success: {
      bg: blend("21, 143, 100", 0.12),
      color: "var(--success)",
      border: blend("21, 143, 100", 0.3),
    },
    warning: {
      bg: blend("211, 137, 36", 0.12),
      color: "var(--warning)",
      border: blend("211, 137, 36", 0.3),
    },
    danger: {
      bg: blend("204, 77, 77", 0.12),
      color: "var(--danger)",
      border: blend("204, 77, 77", 0.3),
    },
    info: {
      bg: blend("31, 110, 150", 0.12),
      color: "var(--info)",
      border: blend("31, 110, 150", 0.3),
    },
  };
  const v = variants[variant] || variants.default;
  const fontSize =
    size === "xs" ? "0.65rem" : size === "sm" ? "0.72rem" : "0.8rem";
  const padding =
    size === "xs" ? "2px 6px" : size === "sm" ? "3px 8px" : "5px 12px";
...
export const ScoreRing = ({ score = 0, size = 160, strokeWidth = 10 }) => {
  ...
  const getColor = (s) => {
    if (s >= 80) return "#158f64";
    if (s >= 60) return "#d38924";
    return "#cc4d4d";
  };
      ...
      <div style={{ position: "relative" }}>
        ...
        <input
          ...
          style={{
            ...
            outline: "none",
            boxShadow: focused
              ? `0 0 0 3px ${error ? "rgba(255,107,107,0.15)" : "var(--primary-glow)"}`
              : "none",
            ...style,
          }}
        />
